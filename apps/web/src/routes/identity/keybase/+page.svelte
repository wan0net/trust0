<script lang="ts">
	...
	async function handleAddProof() {
		...
		if (!/^[a-zA-Z0-9_]+$/.test(name)) {
			error = "Invalid Keybase username"; return;
		}
		const claimUri = `https://keybase.io/${name}`;
...
<div class="page-header">
	...
	<h1>Add Keybase Proof</h1>
	<p>Link your legacy Keybase account to your identity</p>
</div>
...
{:else if success}
	<div class="card">
		...
		<div class="card-body">
			<p style="color: var(--green); font-weight: 500; margin-bottom: 16px;">Keybase proof added successfully!</p>
...
{:else}
	...
	<div class="grid">
		<div class="card">
			<div class="card-header">Step 1: Add Proof to Keybase</div>
			<div class="card-body">
				...
				<p style="color: var(--text-dim); font-size: 13px; margin-top: 12px;">
					Note: Keybase is no longer actively maintained. This proof links your legacy Keybase identity.
				</p>
			</div>
		</div>
